...
| Doc | For |
|---|---|
| [User guide](user-guide.md) | installing, setting up a repo, wiring CI, `.cdc.yml` (pins, canary, budget), reading a red check, the drift index, FAQ |
| [Architecture](architecture.md) | components, the two tracks, data flow, trust boundaries |
